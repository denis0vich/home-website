      ...
      <div className="story-content-area">
        ...
        <article className="max-w-4xl mx-auto px-6 py-20">
          ...
          <div className="prose prose-lg max-w-none">
            {/* Section 1: Dream of Perfect Home - Light Blue/Sparkles */}
            <StorySection 
            ...
            >
              <div className="max-w-5xl mx-auto px-6">
                ...
                <ScrollAnimation direction="fadeIn">
                  <p className="mb-8 text-center text-xl leading-relaxed font-light" style={{ color: 'inherit' }}>
                    He closed his eyes.
                  </p>
                </ScrollAnimation>
            ...
            {/* Section 2: Reality - Paco Apartment - Dark/Gray */}
            <StorySection 
            ...
            {/* Section 3: Financial Anxiety - Dark Blue */}
            <StorySection 
            ...
            {/* Section 4: Beach/Sea Escape - Bright Blue/Sparkles */}
            <StorySection 
            ...
            {/* Section 5: Near-Drowning - Dark Blue/Black - INTENSE */}
            <StorySection 
            ...
            {/* Section 6: Dating/Rejection - Dark Gray */}
            <StorySection 
            ...
            {/* Section 7: Mother's Love - Warm Yellow/Sparkles */}
            <StorySection 
            ...
            {/* Section 8: Dream Home Vision - Light Blue/Sparkles */}
            <StorySection 
            ...
            {/* Section 9: Mountain/Hope - Warm/Light - Sparkles */}
            <StorySection 
