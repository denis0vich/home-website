        ...
        <div className="max-w-7xl mx-auto px-6 py-20">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12 max-w-5xl mx-auto">
            {features.map((feature, index) => (
              <ScrollAnimation key={feature.id} direction="zoomIn" delay={400 + (index * 100)}>
                <Link href={feature.href}>
                  <div className={`bg-gradient-to-br ${feature.gradient} rounded-xl p-8 h-full shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 cursor-pointer`}>
