        ...
        <article className="max-w-4xl mx-auto px-6 py-20">
          ...
          <div className="prose prose-lg max-w-none">
            <ScrollAnimation direction="fadeIn" duration={1200}>
              <p className="text-2xl md:text-3xl leading-relaxed text-black mb-16 italic font-light text-center max-w-3xl mx-auto">
            ...
            <ScrollAnimation direction="fadeInUp" duration={1000}>
              <section className="mb-12">
                ...
                <p className="mb-6 leading-relaxed text-black" style={{ color: '#000000', textShadow: 'none' }}>
            ...
            <ScrollAnimation direction="fadeInUp">
              <section className="mb-12">
                ...
                <ul className="list-disc pl-8 mb-6 space-y-4 text-black" style={{ color: '#000000', textShadow: 'none' }}>
                ...
                <p className="mb-6 leading-relaxed text-black font-bold text-lg" style={{ color: '#000000', textShadow: 'none' }}>
